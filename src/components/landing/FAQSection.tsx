...
const FAQ_DATA: FAQCategory[] = [
    ...
    },
    {
        ...
        items: [
            {
                question: '상권 모든 구역에서 상위 노출돼야 지역명 키워드에서도 1위가 됩니다',
                answer:
                    '사장님들이 목표로 하는 "건대역 카페" 같은 지역명 키워드 상위노출, 어떻게 달성할 수 있을까요?\n\n네이버는 상권 내 어디서 검색해도 순위가 높은 매장을 "이 지역의 대표 매장"으로 인식합니다. 즉, 상권 전체에서 업종 키워드 순위가 높아야, 지역명 키워드에서도 상위에 노출될 수 있습니다.\n\n맵타민은 상권 내 수십 개 좌표에서 내 매장의 순위를 지도 위에 색으로 보여줍니다. 초록불이 많아질수록 네이버가 지역 대표로 인식하고, 결과적으로 지역명 키워드 순위까지 올라갑니다.',
            },
            {
